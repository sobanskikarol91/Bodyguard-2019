...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        public CameraShakeInstance ShakeOnce(CameraShakeSettings settings)
        {
            CameraShakeInstance shake = new CameraShakeInstance(settings.Magnitude, settings.Roughness, settings.FadeInTime, settings.FadeOutTime);
            shake.PositionInfluence = DefaultPosInfluence;
            shake.RotationInfluence = DefaultRotInfluence;
            cameraShakeInstances.Add(shake);
